...
// end include: preamble.js
  ...
  function _wgpuAdapterRelease(id) { WebGPU.mgrAdapter.release(id) }
  ...
  function _wgpuBindGroupLayoutReference(id) { WebGPU.mgrBindGroupLayout.reference(id) }
  ...
  function _wgpuBufferReference(id) { WebGPU.mgrBuffer.reference(id) }

  function _wgpuBufferRelease(id) { WebGPU.mgrBuffer.release(id) }

  function _wgpuCommandBufferRelease(id) { WebGPU.mgrCommandBuffer.release(id) }
  ...
  function _wgpuCommandEncoderRelease(id) { WebGPU.mgrCommandEncoder.release(id) }
  ...
  function _wgpuDeviceReference(id) { WebGPU.mgrDevice.reference(id) }

  function _wgpuDeviceRelease(id) { WebGPU.mgrDevice.release(id) }
  ...
  function _wgpuInstanceCreateSurface(instanceId, descriptor) {
      ...
      var context = offscreen.getContext('webgpu');
      assert(context);
      if (!context) return 0;
  ...
  function _wgpuPipelineLayoutRelease(id) { WebGPU.mgrPipelineLayout.release(id) }

  function _wgpuQuerySetRelease(id) { WebGPU.mgrQuerySet.release(id) }

  function _wgpuQueueRelease(id) { WebGPU.mgrQueue.release(id) }
  ...
  function _wgpuRenderPassEncoderRelease(id) { WebGPU.mgrRenderPassEncoder.release(id) }
  ...
  function _wgpuSamplerReference(id) { WebGPU.mgrSampler.reference(id) }

  function _wgpuSamplerRelease(id) { WebGPU.mgrSampler.release(id) }

  function _wgpuShaderModuleReference(id) { WebGPU.mgrShaderModule.reference(id) }

  function _wgpuShaderModuleRelease(id) { WebGPU.mgrShaderModule.release(id) }

  function _wgpuSurfaceReference(id) { WebGPU.mgrSurface.reference(id) }
  ...
  function _wgpuTextureReference(id) { WebGPU.mgrTexture.reference(id) }

  function _wgpuTextureRelease(id) { WebGPU.mgrTexture.release(id) }

  function _wgpuTextureViewReference(id) { WebGPU.mgrTextureView.reference(id) }
...
var __Z7init_inhh = Module['__Z7init_inhh'] = createExportWrapper('_Z7init_inhh');
var _malloc = Module['_malloc'] = createExportWrapper('malloc');
var _OnBufferReceived = Module['_OnBufferReceived'] = createExportWrapper('OnBufferReceived');
var _OnYUVBufferReceived = Module['_OnYUVBufferReceived'] = createExportWrapper('OnYUVBufferReceived');
var _StartRendering = Module['_StartRendering'] = createExportWrapper('StartRendering');
var _SetupViewport = Module['_SetupViewport'] = createExportWrapper('SetupViewport');
